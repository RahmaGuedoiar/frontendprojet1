...
<div className='addproduct-itemfield'>
    ...
    <input ref={Name}  type='text' name='name' placeholder='Product Title'/>

</div>
<div className='addproduct-itemfield'>
    
    <input  ref={Description}  type='text' name='description' placeholder='Product Description'/>

</div>
<div className='addproduct-price'>
<div className='addproduct-itemfield'>
 
    <input ref={Oldprice}  type='text' name='old_price' placeholder=' Price'/>

</div>
<div className='addproduct-itemfield'>
    
    <input ref={Newprice}  type='text' name='new_price' placeholder='Offre  Price'/>
