        ...
        {Array.isArray(product) && product.map((el) => (
          ...
          <>
            <div className='listproduct-format-main  listproduct-format'>
              ...
              <div className="UPDATEprodcut">

                <div className='addproduct-itemfield'>
                  
                  <input type='text' name='name' placeholder='Product Title' onChange={(event) => {
                ...
                <div className='addproduct-itemfield'>
                  ...
                  <input type='text' name='description' placeholder='Product Description' onChange={(event) => {
                ...
                <div className='addproduct-price'>
                  <div className='addproduct-itemfield'>
                    ...
                    <input type='text' name='old_price' placeholder='Price ' onChange={(event) => setData({ ...data, old_price: event.target.value })} />

                  </div>
                  <div className='addproduct-itemfield'>
                  
                    <input type='text' name='new_price' placeholder='Offre  Price ' onChange={(event) => setData({ ...data, new_price: event.target.value })} />
